...
The [lite version](sawgraph-spatial-ontology-lite.ttl) comments out superproperties and superclasses that are not needed for effective querying of the data, shrinking the number of inferred triples to improve performance.
