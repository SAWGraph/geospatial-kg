...
input2 = 'ttl_files/AdministrativeRegion_2/' + state_abbrev + '_' + state_fips + '_admin-regions_level-2.ttl'
input3 = 'ttl_files/AdministrativeRegion_3/' + state_abbrev + '_' + state_fips + '_admin-regions_level-3.ttl'
inputs = [input1, input2, input3]

### Output File ###
output = 'ttl_files/class_statements/' + state_abbrev + '_' + state_fips + 'admin-region_class-statements.ttl'
...
with open (output, 'w') as outfile:
    ...
    # Find the class statements in each input file and write them to the output file
