...
Under ### INPUT Filenames ###, define
    the name (and path) of each input .zip files
...
input_counties = 'ttl_files/illinois_counties_s2_relations.zip'
input_state = 'ttl_files/illinois_state_s2_relations.zip'

### OUTPUT Filenames ###
# output_file: this is for the resulting .ttl files
county_output_file = 'ttl_files/s2-il_admin-regions_level-2.ttl'
state_output_file = 'ttl_files/s2-il_admin-regions_level-1.ttl'

logname = 'logs/log_IL_AdminRegionLevels12-S2-2-ttl.txt'
...
if __name__ == "__main__":
    ...
    logger.info('Processing the zipped S2L13 .ttl files')
