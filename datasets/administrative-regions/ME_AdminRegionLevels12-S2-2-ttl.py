...
input_counties = 'ttl_files/maine_counties_s2_relations.zip'
input_state = 'ttl_files/maine_state_s2_relations.zip'

### OUTPUT Filenames ###
# output_file: this is for the resulting .ttl files
county_output_file = 'ttl_files/s2-me_admin-regions_level-2.ttl'
state_output_file = 'ttl_files/s2-me_admin-regions_level-1.ttl'

logname = 'logs/log_ME_AdminRegionLevels12-S2-2-ttl.txt'
